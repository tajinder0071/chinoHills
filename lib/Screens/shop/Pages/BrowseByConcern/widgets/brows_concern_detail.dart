                                        ...
                                        onTap: () {
                                          Get.bottomSheet(
                                            CommonBottomSheet(
                                              ...
                                              onApply: () {
                                                print(newCon.selectFilterValue);
                                                String index = newCon
                                                    .selectFilterValue
                                                    .toString()
                                                    .replaceAll('[', '')
                          ...
                          children: [
                            ...
                            browseController.treatment.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemCount:
                                        browseController.treatment.length,
                                    itemBuilder: (context, index) {
                                      var treat =
                                          browseController.treatment[index];
                                      List<String> concerns = treat.concerns!
                                        ...
                                        child: Column(
                                          children: [
                                            PackageCard(
                                              ...
                                              description:
                                                  treat.description ?? "",
                                              imageUrl: treat.image!.isEmpty
                                                  ? ""
                                                  : treat.image!,
                                              originalPrice:
                                                  treat.price.toString() ?? 0.0,
                                              memberPrice:
                                                  treat.membershipOfferPrice
                                                      .toString(),
                                              tags: concerns,
