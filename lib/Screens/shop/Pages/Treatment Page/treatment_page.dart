                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: Column(
                                  children: [
                                    PackageCard(
                                      title: product.treatmentName ?? "",
                                      description:
                                          product.treatmentDescription ?? "",
                                      imageUrl:
                                          (product.treatmentImagePath != null &&
                                              product
                                                  .treatmentImagePath!
                                                  .isNotEmpty)
                                          ? product.treatmentImagePath![0]
                                          : "",
                                      originalPrice: product.treatmentPrice
                                          .toString(),
                                      memberPrice: product.membershipPrice == ""
                                          ? "0.0"
                                          : product.membershipPrice!.toString(),
                                      tags: concerns,
                                      discount:
                                          product.reward == null ||
                                              product.reward!.isEmpty
                                          ? 0
                                          : int.parse(
                                              double.parse(
                                                product.reward.toString(),
                                              ).toStringAsFixed(0),
                                            ),
