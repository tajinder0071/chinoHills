                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(
                        con.packageHeaderImage,
                      ),
                      fit: BoxFit
                          .cover, // Adjust to cover instead of 'none'
                    ),
                  ),
                  child: Stack(
                    children: [
                      ...
                      Positioned.fill(
                        child: Row(
                          children: [
                            ...
                            Container(
                                width: 100.w, color: Colors.transparent),
                          ],
                        ),
                      ),
                      // Text Content
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              treatController.treatmentListModel.headerDetails!.headerTitle ==
                                  null
                                  ? "Curated\nTreatments"
                                  : treatController.treatmentListModel.headerDetails!.headerTitle
                                  .toString(),
                            ...
                            SizedBox(height: 5.h),
                            Text( treatController.treatmentListModel.headerDetails == null
                                ? "Shop our treatment"
                                : treatController.treatmentListModel.headerDetails!.headerDescription
                                .toString(),
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 14.sp,
                          ...
                          children: [
                            PackageCard(
                              ...
                              product.membershipOfferPrice == ""
                                  ...
                                  .toString(),
                              tags: concerns,
                              discount: product.offeroffText == null || product.offeroffText!.isEmpty
                                  ? 0
                                  : product.offeroffText,
                              // int.parse(double.parse(product
                              //             .offeroffText
                              //             .toString())
                              //         .toStringAsFixed(0)),
