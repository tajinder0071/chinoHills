      ...
      children: [
        Padding(
          ...
          child: ClipRRect(
            ...
            child: SizedBox(
              height: 250.0.h,
              child: data.treatmentImagePaths!.isEmpty
                  ? Container(
                      height: 250.h,
                  ...
                  : PageView.builder(
                      ...
                      itemCount: data.treatmentImagePaths?.length ?? 0,
                      onPageChanged: (index) =>
                          controller.currentPage.value = index,
                      itemBuilder: (context, index) {
                        return Image.network(
                          (data.treatmentImagePaths != null &&
                                  data.treatmentImagePaths!.isNotEmpty)
                              ? data.treatmentImagePaths![index]
                              : "",
                          fit: BoxFit.contain,
                          width: double.infinity,
        ...
        // Page indicator dots
        if (data.treatmentImagePaths == null)
          SizedBox.shrink()
        else if (data.treatmentImagePaths!.length <= 1)
          SizedBox.shrink()
        else
          Obx(() => Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: List.generate(
                  data.treatmentImagePaths?.length ?? 0,
