    ...
    return Column(
      children: [
          ...
          child: ClipRRect(
            ...
            child: SizedBox(
              ...
              child: PageView.builder(
                ...
                itemCount: (data.packageImages?.isNotEmpty ?? false)
                    ? data.packageImages!.length
                    : 1,
                onPageChanged: (index) => controller.currentPage.value = index,
                itemBuilder: (context, index) {
                  return Image.network(
                    (data.packageImages != null &&
                            data.packageImages!.isNotEmpty)
                        ? data.packageImages![index]
                        : "",
                    fit: BoxFit.contain,
        ...
        if (data.packageImages == null)
          SizedBox.shrink()
        else if (data.packageImages!.length <= 1)
          SizedBox.shrink()
        else
          Obx(() => Row(
