...
import 'package:chino_hills/common_Widgets/common_refer_widget.dart';
...
class HomePage extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                  EdgeInsets.symmetric(horizontal: mediaQuery.width * 0.15),
                ...
                buildchino_hillsRewardImageSection(controller, context),
                controller.homeData.isEmpty
                    ? SizedBox.shrink()
                    : BecomeAMember(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      BestSellingWidget(
                        exploreAllServiceOnTap: exploreAllServiceOnTap,
                        onTap: onTap,
                      ),
                      SizedBox(height: mediaQuery.height* 0.03),
                    ],
  ...
  Widget buildRewardSection(context, ShopController controller) {
    var mediaQuery = MediaQuery.of(Get.context!).size;
    return Padding(
      padding: EdgeInsets.only(left:mediaQuery.height * 0.01,right: mediaQuery.height * 0.01),
      child: Column(
        children: [
          controller.homeData.isEmpty
              ? SizedBox.shrink()
  ...
  Widget buildchino_hillsRewardImageSection(ShopController controller, context) {
    ...
    return SizedBox(
      ...
      child: controller.homeData.isEmpty
        ...
        itemCount:
        (controller.homeData[0].announcementOffers?.length ?? 0) +
            1,
              ...
              child: Stack(
                ...
                children: [
                  Image.network(
                    (controller.homeData[0].headerImage != null &&
                        controller
                            .homeData[0].headerImage!.isNotEmpty)
                        ? controller.homeData[0].headerImage
                        .toString()
                        : "",
                    fit: BoxFit.cover,
                    width: double.infinity,
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          Text(
                            controller.homeData[0].subheader
                                .toString(),
                            textAlign: TextAlign.center,
                            style: GoogleFonts.merriweather(
                                fontSize: 14.sp,
  ...
  Widget buildBrowseByConcernSection(
      ShopController controller, VoidCallback onShopPage) {
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.roboto(
                fontSize: 16.sp, color: AppColor().greyColor),
          ),
          SizedBox(height: size.height * 0.02),
          CommonButtonWidget(
            onTap: onShopPage,
