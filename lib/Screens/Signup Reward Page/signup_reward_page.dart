...
class RewardUnlockedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    controller.getRewardAPI();
    return GetBuilder<RewardUnlockedController>(
      builder: (controller) {
        return Scaffold(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: AnimatedOpacity(
                                ...
                                opacity: controller.showRewardCard.value
                                    ? 1.0
                                    : 0.5,
                                child: Icon(
                            ...
                            children: [
                              ...
                              AnimatedOpacity(
                                ...
                                child: Transform.scale(
                                  scale: controller.showRewardCard.value
                                      ? 1.0
                                      : 0.8,
                                  child: Container(
                                    width: double.infinity,
